    ...
    const tabContent1 = () => (
        <div className={post.description}>
            ...
            <p>
                ...
                web, I recreated the site using ReactJs. The site contains card
                styled content, with monkey jokes generated by GPT-4.
            </p>
            ...
            <p>
                ...
                expanded. Then, I created a banner component for the largest
                image and text block. A Card Component was created that took
                inputs title and description, reused in the postGrid component.
            </p>
        </div>
    );
    ...
    const tabContent2 = () => (
        <div className={post.description}>
            ...
            <p>
                ...
                authenticated API call, and dynamic component loading.
                Originally a styling exercise, it evolved into a demonstration
                of integrating React with third-party APIs and JSON data
                manipulation.
            </p>
        </div>
    );
